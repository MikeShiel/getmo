...
import subwayHero from '@/assets/spotlight/subway-surfers.png';
import bounceHero from '@/assets/spotlight/bouncemasters.png';
import speedyHero from '@/assets/spotlight/speedy-runner.png';
import cutRopeHero from '@/assets/spotlight/cut-the-rope.png';
import subwayIcon from '@/assets/spotlight/icon-subway.png';
import bounceIcon from '@/assets/spotlight/icon-bounce.png';
import speedyIcon from '@/assets/spotlight/icon-speedy.png';
...
const SPOTLIGHT: SpotlightItem[] = [
  { id: 'subway-surfers-berlin', title: 'Subway Surfers Berl…', genre: 'Arcade', hero: subwayHero, icon: subwayIcon },
  { id: 'bouncemasters', title: 'Bouncemasters: Pe…', genre: 'Arcade', hero: bounceHero, icon: bounceIcon },
  { id: 'speedy-runner', title: 'Speedy Runner', genre: 'Arcade', hero: speedyHero, icon: speedyIcon },
  { id: 'cut-the-rope', title: 'Cut the Rope', genre: 'Puzzle', hero: cutRopeHero, icon: cutRopeHero },
];

export function FeaturedGamesCarousel(_props: Props) {
