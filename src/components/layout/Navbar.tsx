...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 h-16 flex items-center gap-3 bg-sidebar border-b border-sidebar-border px-3 md:px-6">
      <SidebarTrigger className="text-sidebar-foreground/80 hover:text-sidebar-foreground shrink-0" />
      <Link to="/" className="flex items-center shrink-0">
        <img src={getmoLogo} alt="Getmo" className="h-9 md:h-10" />
      </Link>
